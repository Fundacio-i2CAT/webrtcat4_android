...
public class AppRTCAudioManager {
  ...
  // LINO removing for now; not used
  ...
  /* LINO commenting out the proximity sensor stuff for now (not currently needed)
  ...
  */
  ...
  private AppRTCAudioManager(Context context,
    ...
    /* LINO commenting out the proximity sensor stuff (not needed currently)
