...
public class WebRTCatPeerConnectionClient {
  ...
  public interface PeerConnectionEvents {
    ...
    /**
     * webrtcat extension: Callback fired if ICE connection failed (IceConnectionState is
     * FAILED)
     */
    void onIceFailed();
  ...
  public void addLocalMediaStream(final EglBase.Context renderEGLContext) {
    executor.execute(new Runnable() {
      @Override
      public void run() {
        mediaStream = factory.createLocalMediaStream("ARDAMS");
